    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="home">PROYECTO</a>
            </div>
            <!-- /.navbar-header -->
                        ...
                        <li>
                            <a href="#">
                                <div>
                                    ...
                                    <span class="pull-right text-muted small">hace 4 minutoso</span>
                                </div>
                            </a>
                        </li>
                        <li class="divider"></li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href=""><i class="fa fa-dashboard fa-fw"></i> Por Definir</a>
                        </li>
                        <li>
                            <a href="tables"><i class="fa fa-table fa-fw"></i> Tablas<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="tables"> Tabla de Prueba</a>
                                </li>
                                <li>
                                    <a href=":)"> Aqui se agregan las demas tablas</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="forms"> Mantenimiento de prueba</a>
                                </li>
                                <li>
                                    <a href=":)"> Aqui se agregan los demas Mantenimientos</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
